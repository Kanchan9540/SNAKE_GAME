...
const musicSound = new Audio('./image/music.mp3');
let speed = 6;
let score = 0;
let lastPaintTime = 0;
let snakeArr = [
...
// game functions
function main(ctime) {
    window.requestAnimationFrame(main); // here main is make a game loop.
    //console.log(ctime);
...
function gameEngine(){
  ...
  for(let i = snakeArr.length - 2; i>=0; i--){
    snakeArr[i+1] = {...snakeArr[i]};  // here we cretae a new object.
  }
